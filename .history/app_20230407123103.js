...
// Set background color of rows A to G to green-accent
  sheet.getCell(`A${row.number}:G${row.number}`).fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'C6EFCE' } // Set background color to green-accent
  };
  }  
