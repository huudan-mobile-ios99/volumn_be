    ...
    if (err) {
      ...
      if (data == null || data.length == 0) {
       ...
       const workbook = XLSX.utils.book_new();
        ...
        XLSX.utils.sheet_set_row(sheet, 0, { hpt: 40 }); // Set row height of row 1 to 40
        XLSX.utils.sheet_set_column(sheet, 0, { width: 15 }); // Set column width of column A to 15
        XLSX.utils.sheet_set_column(sheet, 1, { width: 10 }); // Set column width of column B to 10
