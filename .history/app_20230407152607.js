    ...
    promotionHistoryModel.find(function (err, data) {
        if (err) {
            ...
            if (data == null || data.length === 0) {
                ...
                const excelFileName = `promotion_history_${date}_${randomString}.xlsx`; // Generate a unique file name
...
console.log(formattedTimestamp); // Output: "04-05-2023_11-20"
In this example, the getFormattedTimestamp function encapsulates the logic for formatting the timestamp into a separate function, making it reusable and returning the formatted timestamp string as the function's result. The function is then called and the result is stored in the formattedTimestamp variable, which can be used as needed.
