    ...
    if (err) {
      ...
      if (data == null || data.length == 0) {
       ...
       const workbook = XLSX.utils.book_new();
        ...
        XLSX.utils.sheet_set_row_height(sheet, 0, 40); // Set row height of row 1 to 40
        XLSX.utils.sheet_set_column_width(sheet, 0, 15); // Set column width of column A to 15
        XLSX.utils.sheet_set_column_width(sheet, 1, 10); // Set column width of column B to 10
