...
app.post('/list_promotion_history_by_dates', async (req, res) => {
const { startDate, endDate } = req.body; // Extracting startDate and endDate from request body
            ...
            if (data == null || data.length === 0) {
                ...
                workbook.xlsx.writeFile(excelFilePath)
                    .then(() => {
                        ...
                        res.send({ "status": true, "message": "Promotion history Excel file generated and saved on server", "filePath": ex });
                    })
                    .catch((err) => {
                        console.error(err);
...
app.get('/download_promotion_history', async (req, res) => {
  ...
  //filePath is set in postman to sent get request 
