...
app.get("/file/:filename", async (req, res) => {
    try {
        const file = await config.clientConnect.db.collection('photos.files').insertOne({ filename: req.params.filename });
...
// config.clientConnect.db.collection('test').insertOne({ name: 'John Doe11', age: 211 }, (err, result) => {
//     if (err) {
//       console.error(err);
//       client.close();
//       return;
