...
class OperationService {
    ...
    static async checkUserLogin(req, res) {
        ...
        try {
            ...
            if (existingUser) {
                return res.json({ status: true, message: `Login Successful - User:${name}`, data: existingUser });
            }else{
                return res.json({ status: false, message: 'Login un-successful', data: existingUser });
