  ...
  promotionHistoryModel.find(function (err, data) {
    if (err) {
      ...
      if (data == null || data.length === 0) {
        ...
        sheet.getColumn(2).width = 5; // Set column width of column B to 10
        sheet.getColumn(3).width = 5; // Set column width of column B to 10
        sheet.getColumn(4).width = 5; // Set column width of column B to 10
        sheet.getColumn(5).width = 5; // Set column width of column B to 10
